const SPELLS = [
  { id: 'stream', name: 'Stream', element: 'fire', kind: 'stream', hint: 'line of 3 — 2 dmg / 1 push, paints fire', castRange: 3, castAttack: 2, castDisplacement: 1, paint: true },
  { id: 'inferno', name: 'Inferno', element: 'fire', kind: 'burst', hint: '3×3 fire — 2 dmg, paints magma', castRange: 3, castAttack: 2, castDisplacement: 0, paint: true, hitNexus: false, burstRadius: 1, special: 3 },
  { id: 'cinder', name: 'Cinder', element: 'fire', kind: 'burst', hint: 'one tile — 1 dmg, paints fire', castRange: 4, castAttack: 1, castDisplacement: 0, paint: true, hitNexus: false, burstRadius: 0 },
  ...
  { id: 'sheet', name: 'Sheet', element: 'ice', kind: 'stream', hint: 'line of 3 — 1 dmg, paints ice, no push', castRange: 3, castAttack: 1, castDisplacement: 0, paint: true },
  ...
  { id: 'gust', name: 'Gust', element: 'wind', kind: 'gust', hint: 'line of 3 — 1 dmg / 2 push, paints wind', castRange: 3, castAttack: 1, castDisplacement: 2, paint: true },
  ...
  { id: 'draft', name: 'Draft', element: 'wind', kind: 'stream', hint: 'line of 4 — 3 push, paints wind', castRange: 4, castAttack: 0, castDisplacement: 3, paint: true, special: 2 },
  { id: 'tug', name: 'Tug', element: 'wind', kind: 'pull', hint: 'line of 3 — yank 2 toward you, paints wind', castRange: 3, castAttack: 1, castDisplacement: 2, paint: true },
...
// Spell 1 is a basic. Cost is 1× kit cost.
