function renderRulesPage() {
  return (
    '<article class="page">' +
      ...
      '<p>Dark chevrons, not discs. Each body is one Into the Breach archetype, 1 damage. They attack wizards and the city. A wizard and a nexus are worth the same shot. No empty-air melee.</p>' +
      ...
      '<h2>Setup</h2>' +
      '<ul>' +
        '<li><strong>Defense</strong> — only your camp. <strong>3–6 nexuses</strong> at <strong>2 HP</strong>, packed in one or two city blobs on a <strong>named island</strong>. Terrain can sit against the city. No enemy crystals. Opening: 1–2 pawns on the board with no telegraph and no incoming marks. Incoming is one hole per enemy phase on open field ground, not the last two rows, close enough to attack after a walk. <strong>10 invaders</strong> in a match, <strong>3</strong> on the board at once.</li>' +
      ...
      '<h2>Wizards</h2>' +
      '<p>Melee is a punch. The spell is what you configured on Team. You only have the four bodies you brought. Cost is Vs mana; Defense ignores it. On the board, wizards are <strong>hex gems</strong>; Defense vek are <strong>dark chevrons</strong> that point at their strike.</p>' +
      '<div class="table-wrap">' +
        '<table class="rules-table">' +
