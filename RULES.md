...
Melee is a simple adjacent punch for everyone. The spell is what you configured on Team. You only have the four bodies you brought. **Cost is Vs mana.** Defense ignores it. On the board, your wizards are **hex gems**. Defense vek are **dark chevrons** that point at the strike.
