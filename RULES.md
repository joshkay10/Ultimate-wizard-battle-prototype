...
Play opens on **Vs**: a 7×7 deathmatch with the seven-wizard team from the Team page. Four of yours start on the board; the leftover three stay in hand. The enemy starts on their back rows. Open arena. Three crystals a side. Mission rosters are locked.
...
- **Vs** — a lighter 7×7. **Three nexuses** a camp (5 HP). **Four** of your wizards start on the board; the leftover three stay in hand. The enemy starts on their back rows. **Each turn you gain 1 mana.** Portal leftover bodies into your back three rows. **Mana pays for summons and for specials** — same pool. Wipe the other team, or drop all three of their crystals, to win.
...
- Six kits in the pool. **Pyre, Rime, and Squall are live.** Cairn, Volt, and Chrono are on the bench. **Vs** brings **exactly seven** from the live three (copies allowed). Named islands field **1, then 2, then 3, then 4**. Team has a **randomize** button that rolls seven bodies from those three.
...
- **Vs:** pay mana to portal leftover bodies in, and pay mana to fire specials. Same pool. Rime is **1**, Pyre and Squall are **2**. Round 1 has 2 mana. Each later round you gain 1 mana. Leftover cubes stay under the board.
...
- **Vs** — **three nexuses** a camp. **7×7**. Four of yours start on the board; leftover three in hand. The enemy starts on their back rows. Open arena — no generated mountains or water. Break the other camp, or wipe their wizards.
...
Melee is a simple adjacent punch for everyone. Each wizard also carries **two spells**: a free **basic cast** and a mana-cost **special** (see below). You only have the bodies the island (or Vs team) gave you. **Cost is Vs mana.** Defense ignores summon cost. On the board, your wizards are **cubes**. Defense vek are **dark discs** with a facing wedge that points at the strike when they have one, otherwise toward the city.
...
1. **Summon**
   ...
   - **Vs:** two already on the field. Pay the wizard’s cost to portal another into your back 3 rows (not on a mountain, water, occupied tile, or another portal). They arrive at the start of your **next** turn, burst, then are sick that turn. If **anyone** is standing on the portal when it resolves, the incoming wizard **and** the one standing there both die. Same rules for the enemy. Specials draw from this same mana.
