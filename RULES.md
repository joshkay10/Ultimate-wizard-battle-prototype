...
- **Vs** — a lighter 7×7. **Three nexuses** a camp (5 HP). Three wizards start in each hand; the rest sit on the bench. **Each turn you gain 1 mana and pick up a wizard.** Portal bodies into your back three rows. **Mana pays for summons and for specials** — same pool. Wipe the other team, or drop all three of their crystals, to win.
