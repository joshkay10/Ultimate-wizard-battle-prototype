...
Six kits in the pool. You bring four. Copies are allowed, and each body brings one spell from its element. Pick them on [Team](team.html) for **Vs** — slot 1 starts in the pit, the rest is the stack. The campaign locks a roster per island.
