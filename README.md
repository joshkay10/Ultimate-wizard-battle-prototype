...
Six kits in the pool. You bring seven in **Vs**. Copies are allowed, and each body brings one spell from its element. Pick them on [Team](team.html) for **Vs**. The campaign locks a roster per island.
